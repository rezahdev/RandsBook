            ...
            <form class="w-full md:w-3/4 my-5 bg-white rounded-xl p-3" method="post" action="{{route('books.store') }}">
                    ...
                    <div class="w-full md:w-1/2">
                        ...
                        <div id="author_list" class="w-full">
                            ...
                            <div id="{{ 'author' . ++$authorCount }}">
                                <input class="authors rounded" name="{{ 'author' . $authorCount }}" type="text" value="{{ $author['name'] }}" onkeydown="return event.key != 'Enter';">
                            ...
                            @else
                            <div id="{{ 'author' . ++$authorCount }}">
                                <input onkeypress="inputAuthorFieldChanged(this)" class="authors rounded" name="{{ 'author' . $authorCount }}" type="text" value="" onkeydown="return event.key != 'Enter';">
                                <button onclick="deleteAuthor('author{{ $authorCount }}')" type="button" class="inline-flex items-center p-0.5 ml-2 text-sm text-blue-400 bg-transparent rounded-sm hover:bg-blue-200 hover:text-blue-900 dark:hover:bg-blue-300 dark:hover:text-blue-900" data-dismiss-target="#badge-dismiss-default" aria-label="Remove">
                                    <svg aria-hidden="true" class="w-3.5 h-3.5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    <span class="sr-only">Remove badge</span>
                                </button>
                        ...
                        <input class="w-full md:w-5/6 rounded mb-5 p-2" name="total_pages" type="text" value="{{$book['total_pages'] }}" onkeydown="return event.key != 'Enter';">
                        <br>
                        <label>Number of Pages Read</label>
                        <input class="w-full md:w-5/6 rounded mb-5 p-2" name="read_pages" type="text" value="{{$book['read_pages'] }}" onkeydown="return event.key != 'Enter';">
                    </div>
                    <div class="w-full md:w-1/2">
                        ...
                        <div id="publisher_list">
                            ...
                            <div id="{{'publisher' . ++$publisherCount }}">
                                <input class="publishers rounded" name="{{ 'publisher' . $publisherCount }}" type="text" value="{{$publisher['name'] }}" onkeydown="return event.key != 'Enter';">
                            ...
                            @else 
                            <div id="{{'publisher' . ++$publisherCount }}">
                                <input onkeypress="inputPublisherFieldChanged(this)" class="publishers rounded" name="{{ 'publisher' . $publisherCount }}" type="text" value="" onkeydown="return event.key != 'Enter';">
                                <button onclick="deletePublisher('publisher{{$publisherCount}}')" type="button" class="inline-flex items-center p-0.5 ml-2 text-sm text-blue-400 bg-transparent rounded-sm hover:bg-blue-200 hover:text-blue-900 dark:hover:bg-blue-300 dark:hover:text-blue-900" data-dismiss-target="#badge-dismiss-default" aria-label="Remove">
                                    <svg aria-hidden="true" class="w-3.5 h-3.5" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd"></path></svg>
                                    <span class="sr-only">Remove badge</span>
                                </button>
                        ...
                        <input class="w-full md:w-5/6 rounded mb-5 p-2" name="publish_date" type="text" value="{{$book['publish_date'] }}" onkeydown="return event.key != 'Enter';">
                    </div>
                </div>
                ...
                <div class="flex flex-row justify-start mb-5">
                    <div class="flex flex-row justify-start w-1/2 mr-5">
                        <input id="subject_input_field" class="w-10/12 h-10 rounded mb-5 mr-5 p-2" name="subject" type="text" onkeydown="return event.key != 'Enter';">
