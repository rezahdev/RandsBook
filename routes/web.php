...
Route::get('/wishlist', [WishlistController::class, 'index'])->middleware('auth')->name('books.wishlist');
...
Route::post('/wishlist/add', [WishlistController::class, 'store'])->middleware('auth')->name('books.add_to_wishlist');
...
Route::put('/wishlistToLibrary', [WishlistController::class, 'wishlist_to_library'])->middleware('auth')->name('books.wishlist_to_library');
...
Route::delete('/wishlist/remove', [WishlistController::class, 'delete'])->middleware('auth')->name('books.remove_from_wishlist');
